...
values ('02134876085', 'davi.sousa@ccc.ufcg.edu.br', NULL, FALSE, FALSE, FALSE, TRUE, FALSE, 'Davi Gomes Passos Sousa', '$2a$10$az2.olI4i5xjHVS95FwfDO0bgq2.HSNsCEwt3q3WSaSK/LqfjrvDa', '83940028922', '2030-02-04 22:37:57.733');
/* a senha é 'minhasenha' */

/* kilian@email.com é estudante */
insert into "user" ("cpf", "email", "enrollment", "is_admin", "blocked", "confirmed", "is_student", "is_ufcg_member", "name", "password", "phone_number", "valid_until")
values ('94756423078', 'kilian.melcher@ccc.ufcg.edu.br', '119210352', FALSE, FALSE, FALSE, TRUE, TRUE, 'Kilian Macedo Melcher', '$2a$10$az2.olI4i5xjHVS95FwfDO0bgq2.HSNsCEwt3q3WSaSK/LqfjrvDa', '83940028922', '2030-02-04 22:37:57.733');
/* a senha é 'minhasenha' */

/* mariane@email.com é servidora */
insert into "user" ("cpf", "email", "enrollment", "is_admin", "blocked", "confirmed", "is_student", "is_ufcg_member", "name", "password", "phone_number", "valid_until")
values ('71995449016', 'mariane.carvalho@ccc.ufcg.edu.br', NULL, FALSE, FALSE, TRUE, FALSE, TRUE, 'Mariane Silva de Carvalho', '$2a$10$az2.olI4i5xjHVS95FwfDO0bgq2.HSNsCEwt3q3WSaSK/LqfjrvDa', '83940028922', '2030-02-04 22:37:57.733');
/* a senha é 'minhasenha' */

/* eduardo@email.com é user externo */
insert into "user" ("cpf", "email", "enrollment", "is_admin", "blocked", "confirmed", "is_student", "is_ufcg_member", "name", "password", "phone_number", "valid_until")
values ('70326612033', 'eduardo.cardoso@ccc.ufcg.edu.br', NULL, FALSE, FALSE, TRUE, FALSE, FALSE, 'Eduardo Gabriel Carvalho Lima Cardoso', '$2a$10$az2.olI4i5xjHVS95FwfDO0bgq2.HSNsCEwt3q3WSaSK/LqfjrvDa', '83940028922', '2030-02-04 22:37:57.733');
/* a senha é 'minhasenha' */
